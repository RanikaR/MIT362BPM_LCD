...
#MIT362 Project: Using this code and displaying BPPM onto an LCD. -Ranika, James, George
    ...
    while True:
        ...
        if N > 250 :                                   # avoid high frequency noise
            if  (Signal > thresh) and  (Pulse == False) and  (N > (IBI/5.0)*3.0)  :       
              ...
              lcd.write_string("BPM: {}\n\r".format(BPM))    #originally print 'BPM: {}'.format(BPM). changed code to display LCD. Prints new line after. 
